...
@FacesConverter(value = "maintenanceConverter")
public class MaintenanceConverter implements Converter {

    private MaintenanceFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Maintenance) {
            ...
            return getStringKey(o.getIdMaintenance());
        } else {
    ...
    private MaintenanceFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(MaintenanceFacade.class).get();
